...
local moon_aura = require("hermitcrab_boss/moon_aura")
local phase_scheduler = require("hermitcrab_boss/phase_scheduler")
local shell_bombard = require("hermitcrab_boss/skills/shell_bombard")
